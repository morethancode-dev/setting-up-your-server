...
server.listen(PORT, () => {
    ...
    console.log('   GET  /                  - Главная страница (HTML)');
    console.log('   GET  /api/motivation    - API с мотивационным сообщением (JSON)\n');
    
    console.log('💡 Как проверить доступность из интернета:\n');
    console.log('   Главная страница:');
    console.log(`   ➜ curl http://${EXTERNAL_IP}:${PORT}\n`);
    console.log('   API endpoint:');
    console.log(`   ➜ curl http://${EXTERNAL_IP}:${PORT}/api/motivation\n`);
